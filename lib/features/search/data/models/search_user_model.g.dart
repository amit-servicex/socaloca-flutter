...
_$SearchUserModelImpl _$$SearchUserModelImplFromJson(
    ...
    _$SearchUserModelImpl(
      ...
      appearCount: (json['appearCount'] as num?)?.toInt() ?? 0,
      selfAppearCount: (json['selfAppearCount'] as num?)?.toInt() ?? 0,
      goals: (json['goals'] as num?)?.toInt() ?? 0,
      postCount: (json['postCount'] as num?)?.toInt() ?? 0,
      endorsedBy: (_readEndorseBy(json, 'endorsedBy') as num?)?.toInt() ?? 0,
      followers: (_readFollowers(json, 'followers') as num?)?.toInt() ?? 0,
    );
...
Map<String, dynamic> _$$SearchUserModelImplToJson(
    ...
    <String, dynamic>{
      ...
      'selfAppearCount': instance.selfAppearCount,
