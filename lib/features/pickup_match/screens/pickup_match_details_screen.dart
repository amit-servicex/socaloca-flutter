    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Details
          _buildDetailRow(Icons.stadium, AppStrings.venue,
              _match!.venueName ?? AppStrings.na),
          const SizedBox(height: 12),
          _buildDetailRow(Icons.people, AppStrings.maxPlayers,
              '${_match!.maxPlayer} players'),
          const SizedBox(height: 12),
